...
const COPY = {
  es: {
    ...
    footer: {
      ...
      copyright: '© 2026 Negocio de Bernardo Alarcon · Vela es operado por Negocio de Bernardo Alarcon',
  ...
  en: {
    ...
    footer: {
      ...
      copyright: '© 2026 Negocio de Bernardo Alarcon · Vela is operated by Negocio de Bernardo Alarcon',
